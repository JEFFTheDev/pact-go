...
(https://github.com/JEFFTheDev/pact-go/blob/master/dsl/matcher_test.go)
...
Read more about flexible matching (https://github.com/JEFFTheDev/pact-ruby/wiki/Regular-expressions-and-type-matching-with-Pact.
